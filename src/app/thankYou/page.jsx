                ...
                <div className="pt-4 px-4">
                  <div className="thankyou-bg justify-content-center">
                    ...
                    <p className="thank-msg text-center px-3 px-lg-0">
                      ...
                      shortly. While you wait for it arrive, continue the
                      momentum and have a look at an exclusive breakfast for
                      business owners just like you. Dr Hema Sathish Devadoss
                    ...
                    <div className="row pt-4 justify-content-center">
                      ...
                      <div className="col-lg-6 align-self-center">
                        <p className="thank-msg text-left text-white px-3 px-lg-0">
                          To help you on your new path to success I would like
                          to invite you to an exclusive Feast with business
                          owners <b>just like you!</b> As a new part of my
                          community use the <b>codeword: Cureka</b> to get a
                          discount.
                        </p>

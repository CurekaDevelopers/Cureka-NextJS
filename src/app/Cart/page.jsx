...
export default function Cart() {
  ...
  const onQuantityChange = async (quantity, productId) => {
    try {
      await addProductToCart({ product_id: productId, quantity }, dispatch);    
      dispatch(fetchCartProducts());
      console.log("onQuantityChange onQuantityChange-=-=-=-=-=-=-=-=-",cartProducts);
    } catch (e) {

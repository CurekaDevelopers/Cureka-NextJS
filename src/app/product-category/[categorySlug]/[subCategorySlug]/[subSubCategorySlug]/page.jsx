...
import { fetchProductsFromSubSubCategory } from "../../../../../redux/action";

export async function generateMetadata({ params }) {
  const slugArr = await params?.subSubCategorySlug;
  console.log(slugArr,"=-=-=--=-slugArr=-=-=-");
  
  let products = [];
    try {
      const result = await fetchProductsFromSubSubCategory(slugArr);

...
export default function Productdetails({ productSlug, ssrProduct }) {
  ...
  useEffect(() => {
    if (!ssrProduct) {
      const productsName = productSlug.length -1;
      console.log(productsName,"-=-=-productsName");
      
    fetchProductBySlug(productSlug[productsName]).then((blogRes) => {
      if (blogRes) {

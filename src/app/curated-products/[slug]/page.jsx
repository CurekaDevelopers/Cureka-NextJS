// app/curated-products/[slug]/page.jsx
"use client";
// import React from "react";

// export async function generateMetadata({ params }) {
//   return {
//     title: `Curated: ${params.slug}`,
//   };
// }
...
import houseChimney from "../../../public/images/houseChimney.png";
...
const CuratedProductPage = ({ params }) => {
  const { slug } = params;
  ...
  useEffect(() => {
    dispatch(fetchCuratedProducts(slug));
  }, [dispatch, fetchCuratedProducts, slug]);
  ...
  // You can use `slug` to fetch content from an API or local data
  return (
    // <div style={{ padding: "20px" }}>
    //   <h1>Curated Page: {slug}</h1>
    //   {/* Render products or banners related to slug */}
    // </div>
    ...
    <div className="container-fluid px-lg-0">
      ...
      <div className="container">
        <div className="d-flex home-back-section">
          ...
          <Link
            href={`/curated-products/${slug}`}
            className="section mb-0 ml-3"
          >
            / <span className="ml-3">{slug || "Search result"}</span>
          </Link>
        </div>
      </div>
...
export default CuratedProductPage;

...
export const validationSchema = Yup.object().shape({
  ...
  sku_code: Yup.string().matches(skuCodeRegex, "Allow only Upper-case Alphabet, / and numbers only").optional("Cureka SKU is required"),
  brand: Yup.string().required("Brand is required"),
  manufacturer_name_and_address_with_pincode: Yup.string().required("Manufacturer name and address is required"),


  url: Yup.string()
    .matches(urlSlugRegex, "Invalid URL slug format. Please use only lowercase letters, numbers, and hyphens.",)
    .required("Blog URL slug is required"),

  packer_name_and_address_with_pincode: Yup.string().required("Packer name and address is required"),

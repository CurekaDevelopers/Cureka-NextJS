...
const renderPolicypage = dynamic(
  () => import("../../../app/admin/PrivacyPolicyPage/page.jsx"),
  {
    ssr: false,
  }
);
const sideBarItems = [
  ...
  { label: "Concerns Management", path: [pagePaths.adminConcern], id: 6 },
  ...
  },
  {
    ...
    render: () => renderPolicypage("Terms & Conditions", "termsAndConditions"),
    id: 8,
  },
  {
        ...
        <Impersonation key={item.id} moduleId={item.id}>
          <Link
            ...
            className={`${styles.link} ${
              item.path.includes(pathname) ? styles.selected : ""
            }`}
          >

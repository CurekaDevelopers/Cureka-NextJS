...
export default function PrivacyPolicy({ policyName, policySlug }) {
  ...
  return (
    <>
      <Helmet>
        <title>{policyName} - Cureka - Online Health Care Products Shop</title>
        <meta name="description" content={`${policyName} - Cureka is one of the leading online healthcare store dealing with the best in class home health careproducts`} />
        ...
        <meta property="og:description" content={`${policyName} -  Cureka is one of the leading online healthcare store dealing with the best in class home health careproducts`} />

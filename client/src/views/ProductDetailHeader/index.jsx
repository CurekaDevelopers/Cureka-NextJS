...
import { generateUrl, productHeaderFixedHeight } from "../../utils/constants/common.constants";
...
export default function ProductdetailHeader() {
  ...
  const fetchItems = async (searchTerm) => {
    ...
    const response = await api.get(apiUrls.productsList + "?search_term=" + searchTerm);
    return [response.data.brands, response.data.categories, response.data.products];
  };

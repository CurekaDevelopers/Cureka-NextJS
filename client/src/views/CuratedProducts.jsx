    ...
    <div className="container-fluid px-lg-0">
      ...
      <div className="container">
        <div className="d-flex home-back-section">
          ...
          <Link to={`/curated-products/${curatedSlug}`} className="section mb-0 ml-3">
            ...
            <div className="row">
              <div className="col-lg-12 order-1 order-lg-2" id="skin-banners">
                ...
                <div className="product-carousel">
                        ...
                        curatedProducts?.map((product, index) => {
                          ...
                          return (
                            <>
                              ...
                              {curatedProducts?.length > 5 && index === 5 && <div className="mb-3">
                                <img
                  ...
                  <div className="curatedProducts-pagination" id="curatedProducts-pagination">
                    <ReactPaginate

...
import creams_banner from "../assets/images/creams_banner.png";
    ...
    <>
      ...
      <div className="container">
        <div className="d-flex home-back-section">
          ...
          <p className="section mb-0 ml-3">/ &nbsp;&nbsp;Skin Care / &nbsp;&nbsp;Creams</p>
        </div>
      ...
      <div className="container">
        ...
        <div className="skin-care">
          <div className="row">
            <div className="col-lg-2 px-lg-0 d-lg-block d-none order-lg-1" id="category-section">
              <div>
                    ...
                    <Accordion.Body className="p-0">
                      <ul className="accor-space list-unstyled mt-3">
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />₹ 0 - ₹ 499
                              <div className="selectall-num">150</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />₹ 500 - ₹ 999
                              <div className="selectall-num">50</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />₹ 1000 - ₹ 1999
                              <div className="selectall-num">120</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />₹ 2000 - ₹ 3999
                              <div className="selectall-num">180</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />₹ 4000 & Above
                              <div className="selectall-num">160</div>
                            </label>
                          </a>
                        </li>
                    ...
                    <Accordion.Body className="p-0">
                      <ul className="accor-space list-unstyled mt-3">
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />4 Stars & Above
                              <div className="selectall-num">150</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />3 Stars & Above
                              <div className="selectall-num">50</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />2 Stars & Above
                              <div className="selectall-num">120</div>
                            </label>
                          </a>
                        </li>
                        ...
                        <li>
                          <a href="#">
                            <label className="selectall">
                              <input type="radio" className="select-input" />1 Star & Above
                              <div className="selectall-num">180</div>
                            </label>
                          </a>
                        </li>
                  ...
                  <div className="modal-content">
                    ...
                    <div className="modal-body">
                      <div className="tab-vertical">
                        <ul className="nav nav-tabs mb-0" id="product-tab" role="tablist">
                          ...
                          >
                            <ul className="list-unstyled">
                              ...
                              <li>
                                <a href="#">
                                  <label className="selectall">
                                    <input type="radio" className="select-input" />₹ 4000 &amp;
                                    Above
                                    <div className="selectall-num">160</div>
                                  </label>
                                </a>
                          ...
                          >
                            <ul className="list-unstyled">
                              <li>
                                <a href="#">
                                  <label className="selectall">
                                    <input type="radio" className="select-input" />4 Stars &amp;
                                    Above
                                    <div className="selectall-num">150</div>
                                  </label>
                                </a>
                              ...
                              <li>
                                <a href="#">
                                  <label className="selectall">
                                    <input type="radio" className="select-input" />3 Stars &amp;
                                    Above
                                    <div className="selectall-num">50</div>
                                  </label>
                                </a>
                              ...
                              <li>
                                <a href="#">
                                  <label className="selectall">
                                    <input type="radio" className="select-input" />2 Stars &amp;
                                    Above
                                    <div className="selectall-num">120</div>
                                  </label>
                                </a>
                              ...
                              <li>
                                <a href="#">
                                  <label className="selectall">
                                    <input type="radio" className="select-input" />1 Star &amp;
                                    Above
                                    <div className="selectall-num">180</div>
                                  </label>
                                </a>
                    ...
                    <div className="filter-wrapper cancel-wrapper d-flex justify-content-end">
                      <div>
                        <a className="text-decoration-done cancel-btn mr-3">Cancel</a>
                      </div>
            ...
            <div className="col-lg-10 skin-banners order-1 order-lg-2" id="skin-banners">
              <div className="d-flex justify-content-between">
                ...
                <div className="dropdown d-lg-block d-none">
                  <DropdownButton title="Sort by : Popularity" id="popularity-sort">
              ...
              <div className="product-carousel">
                <div className="row m-0">
                  <h2 className="products-heading top-space">Featured Products</h2>
                </div>
                  ...
                  <div className="col-lg-12">
                    <div className="container-fluid p-0" id="product-carousal">
                      <Carousel showArrows={true} showStatus={false} showIndicators={false}>
                        <div className="d-flex justify-content-between">
                          <a href="/Productdetails" className="text-decoration-none">
                              ...
                              <div className="arrivals card">
                                ...
                                <div className="d-lg-flex d-flex-column justify-content-between">
                                  <div className="price d-flex d-lg-block">
                                    ...
                                    <p className="product-price">&#8377; 173.00</p>
                                  </div>
                          ...
                          <div className="item mr-3">
                            <div className="arrivals card">
                              ...
                              <div className="product-text">
                                ...
                                >
                                  <p className="product-classNameName text-truncate">
                                    Mesoestetic Melan Recovery – Cosmeceutical Solution 50 ml{" "}
                                  </p>
                                </a>
                              ...
                              <div className="d-lg-flex d-flex-column justify-content-between mb-3">
                                <div className="price d-flex d-lg-block">
                                  ...
                                  <p className="product-price">&#8377; 5900.00</p>
                                </div>
                          ...
                          <div className="item mr-3">
                            <div className="arrivals card">
                              ...
                              <div className="product-text">
                                ...
                                <p className="product-author d-lg-block d-none">
                                  By: <span className="product-author-classNameName">LINUX</span>
                                </p>
                              </div>
                              ...
                              <div className="d-lg-flex d-flex-column justify-content-between mb-3">
                                <div className="price d-flex d-lg-block">
                                  ...
                                  <p className="product-price">&#8377; 163.00</p>
                                </div>
                            ...
                            <div className="item mr-3">
                              <div className="arrivals card">
                                ...
                                <div className="product-text ">
                                  ...
                                  >
                                    <p className="product-classNameName text-truncate ">
                                      Orgello Neem with Turmeric Face Wash 60ml – (Pack of 2)
                                    </p>
                                  </a>
                            ...
                            <div className="item mr-3">
                              <div className="arrivals card">
                                ...
                                <div className="product-text">
                                  ...
                                  >
                                    <p className="product-classNameName text-truncate">
                                      Olnature’s Daily Nourishing Body Lotion 200ml{" "}
                                    </p>
                                  </a>
                                  ...
                                  <p className="product-author d-lg-block d-none">
                                    By:{" "}
                                    <span className="product-author-classNameName">Olnature’s</span>
                                  </p>
                                </div>
                                ...
                                <div className="d-lg-flex d-flex-column justify-content-between mb-3">
                                  <div className="price d-flex d-lg-block">
                                    ...
                                    <p className="product-price">&#8377; 197.00</p>
                                  </div>
                            ...
                            <div className="item mr-3">
                              <div className="arrivals card">
                                ...
                                <div className="product-text">
                                  ...
                                  >
                                    <p className="product-classNameName text-truncate">
                                      Two and A Bud Natural Activated Charcoal Powder 100gm
                                    </p>
                                  </a>
                                ...
                                <div className="d-lg-flex d-flex-column justify-content-between mb-3">
                                  <div className="price d-flex d-lg-block">
                                    ...
                                    <p className="product-price">&#8377; 212.00</p>
                                  </div>
                            ...
                            <div className="item  mr-3">
                              <div className="arrivals card">
                                ...
                                <div className="product-text">
                                  ...
                                  >
                                    <p className="product-classNameName text-truncate">
                                      Olnature’s Exfoliating Papaya Face Wash -100ml (Pack of 2)
                                    </p>
                                  </a>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">SWOSH</span>
                          </p>
                        </div>
                        ...
                        <div className="d-lg-flex d-flex-column justify-content-between">
                          ...
                          <a
                            ...
                            href="#"
                          >
                            <FontAwesomeIcon className="mr-2" icon={faShoppingCart} size="lg" /> Add
                            to Cart
                          </a>
                        </div>
                      </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">The moms co</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">Mama earth</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4 c col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">Cosmotrend</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          >
                            <p className="product-name text-truncate">
                              KLM Ekran Soft Silicone Sunscreen Gel SPF 50+ P+++ (50gm)
                            </p>
                          </a>
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">KLM</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By:{" "}
                            <span className="product-author-classNameName">Maxnova HEALTHCARE</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          >
                            <p className="product-name text-truncate">
                              Enn Tangy – Anti Pigmentation and Collagen Boosting Face Gel
                            </p>
                          </a>
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">Enn BEAUTY</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">UV Doux</span>
                          </p>
                        </div>
                    ...
                    <div className="col-lg-4  col-md-4 col-6 mb-3">
                      <div className="arrivals card">
                        ...
                        <div className="product-text">
                          ...
                          >
                            <p className="product-name text-truncate">
                              Chicco Baby Moment Mild Body Wash No Tears Refresh – 200ml
                            </p>
                          </a>
                          ...
                          <p className="product-author d-lg-block d-none">
                            By: <span className="product-author-classNameName">Chicco</span>
                          </p>
                        </div>
            ...
            <div className="foot-section order-3">
              ...
              <p className="foot-para text-align-left">
                Skin care is something each and every person in the world admire and love to do as
                it supports skin integrity , enhances its appearance and also relieve skin
                conditions. Skin does not only need external applications but also internal care and
                nutrition. Both are interrelated and if the skin damage has happened externally it
                affects the internal layers too. So skin care will be complete with both external
                and internal care. Dermatologist keeping this in mind provide care with cosmetics,
                injections, exfoliations, peeling, laser therapy, fillers, laser resurfacing,
                chemical peels and ultrasonic skin therapies. Proper skin care begins with washing
                the face twice a day. Choose a cleanser that suits your skin type. Never use harsh
                scrubs for facewashing everyday as it may damage your skin. Sunprotection is one of
                the major support that you could give your skin to maintain its health. Sundamage
                may lead not only to pigmentation but also premature aging, wrinkles, freckles, and
                in some cases skin cancers too. Using a proper sunscreen with SPF cares for the skin
                by providing broadspectrum protection from harmful ultraviolet lights. In modern
                times there are sunscreens available in cosmetic markets with blue light filters
                that prevents skin from damages caused by light transmitted from laptop and mobile
                phones.
              </p>
            </div>
          </div>

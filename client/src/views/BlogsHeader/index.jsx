...
export default function BlogsHeader() {
  ...
  function handleSearch(event) {
    if (event.target.value) {
      searchParams.set("search_term", event.target.value);
    } else {
  ...
  const onSearchClicked = () => {
    navigate(`${pagePaths.blogs}?search_term=${searchTerm}`);
  };
          ...
          <nav className="navbar navbar-expand-lg navbar-light bg-white pb-3 px-lg-0 justify-content-between align-items-center">
            ...
            <div>
              <ul className={style.navbarItems}>
                <div>
                  <a href="/track-order" className="text-decoration-none reorder-btn">
                    Track Your Order
                  </a>

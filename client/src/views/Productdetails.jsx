...
import noproduct from "../assets/images/noimageavailable.png";
import copydata from "../assets/images/productCopy.svg";
import mail from "../assets/images/productEmail.svg";
import facebook from "../assets/images/productfacebook.svg";
import linkedin from "../assets/images/productlinkedin.svg";
import share from "../assets/images/productshare.svg";
import Return from "../assets/images/return.svg";
import twitter from "../assets/images/twitter.svg";
import whatsapp from "../assets/images/whatsapp.svg";
import LikeIcon from "../assets/svg-components/LikeIcon";
...
export default function Productdetails() {
  ...
  const { wishlistProducts, cartProducts } = useSelector((state) => state.customer);
  ...
  const openShippingChargesModal = () => setIsOpenShippingCharges(!openShippingCharges);
    ...
    fetchProductBySlug(productSlug).then((blogRes) => {
      if (blogRes) {
        ...
        if (product_reviews && product_reviews.length > 10) {
          const removedProductReviewCopy = product_reviews.slice(10, product_reviews.length);
  ...
  const handleQuantityChange = (e) => {
    ...
    const minQuantity = (product.min_order_quantity > 0) ? product.min_order_quantity : 1;
  ...
  const handlePinCode = () => {
    ...
    if (!pinCode || !/^\d{6}$/.test(pinCode)) {
      toast.error("Please enter a valid 6-digit pincode containing only numbers.");
      return;
    }
    const zipCodes = product.packer_name_and_address_with_pincode.match(zipCodePattern);
    const request = {
  ...
  const loadMoreReviews = () => {
    ...
    const addRemovedItems = [...productCopy.product_reviews, ...removedProductReview];
  ...
  return (
    <>
      <Helmet>
        <title>{product?.meta_title == 'null' ? product?.vendor_article_name : product?.meta_title}</title>
        <meta name="title" content={product?.meta_title == 'null' ? product?.vendor_article_name : product?.meta_title} />
      ...
      <ProductdetailHeader />
      {product && <div className="container-fluid px-0 navbar-margin">
        <div className="container">
          <div className="d-flex home-back-section">
            ...
            <p className="section mb-0 ml-2">
              ...
              <a className="section" href={`/product-category/${product?.category_slug}`} target="_blank">
                {`/ Shop / ${capitalizeFirstLetter(product.category_name)}`}
              </a>
              {product.sub_category_slug && product.sub_category_slug != 'null' && (
                <a
                  href={`/product-category/${capitalizeFirstLetter(product?.category_slug)} /${capitalizeFirstLetter(product?.sub_category_slug)}`}
                  className="section" target="_blank"
                >
                  {` / ${capitalizeFirstLetter(product.sub_category_name)} `}
                </a>
              )}
              {product.sub_sub_category_slug && product.sub_sub_category_slug != 'null' && (
                <a
                  href={`/product-category/${capitalizeFirstLetter(product?.category_slug)}/${capitalizeFirstLetter(product?.sub_category_slug)}/${capitalizeFirstLetter(product?.sub_sub_category_slug)}`}
                  className="section" target="_blank"
                >
                  {` / ${capitalizeFirstLetter(product.sub_sub_category_name)}`}
                </a>
              )}
        ...
        <div className="container">
          <div className="row d-flex-column d-lg-flex position-relative" style={{ overflow: "visible" }}>
            <div className="col-lg-4 mt-3 position-sticky" style={{ top: "300px", zIndex: "1" }}>
                    ...
                    <CarouselSlider
                      settings={{
                        ...
                        beforeChange: (currentSlide, nextSlide) => {
                          console.log("Slide changed to", currentSlide, nextSlide, allProductImages);
            ...
            <div className="col-lg-8 row position-sticky" style={{ top: "370px" }}>
              <h1 className="product-heading p-0 mt-5">{product.vendor_article_name}</h1>

              <div className="col-lg-6 pl-lg-0 mt-5 position-sticky" style={{ top: "370px" }}>
                <h2 className="highlights">Highlights</h2>
                <div className="dynamic-content" dangerouslySetInnerHTML={{ __html: product.product_highlights }}></div>
                <div className="col-lg-6 pl-lg-0 mt-5 position-sticky" >
                  {product.expert_advice !== 'null' && product.expert_advice !== 'undefined' && (
                    <div>
                      <h2 className="highlights">
                        Expert Advice
                      </h2>
                      <div className="dynamic-content" style={{ width: "200%" }} dangerouslySetInnerHTML={{ __html: product.expert_advice }}></div>
                    </div>
                  )}
                </div>
              </div>
              <div className="col-lg-6">
                <div className="d-flex justify-content-end">
                  <div>
                    ...
                    /> */}
                    <Dropdown>
                      <Dropdown.Toggle as="span" variant="link" style={{ textAlign: 'center' }} className="watch productcustom-dropdown-toggle">
                        <img src={share} width="10px" height="10px" alt="share" style={{ cursor: 'pointer', marginLeft: "4px" }} />
                      </Dropdown.Toggle>

                      <Dropdown.Menu>
                        <Dropdown.Item onClick={shareViaEmail}>
                          <img className="img-fluid mr-2" src={mail} width="20px" height="20px" alt="sad" /> Mail
                        </Dropdown.Item>
                        <Dropdown.Item onClick={shareContent}>
                          <img className="img-fluid mr-2" src={whatsapp} width="20px" height="20px" alt="sad" /> What's App
                        </Dropdown.Item>
                        <Dropdown.Item onClick={shareViaFacebook}>
                          <img className="img-fluid mr-2" src={facebook} width="20px" height="20px" alt="sad" /> Facebook
                        </Dropdown.Item>
                        <Dropdown.Item onClick={shareViaTwitter}>
                          <img className="img-fluid mr-2" src={twitter} width="20px" height="20px" alt="sad" /> Twitter
                        </Dropdown.Item>
                        <Dropdown.Item onClick={shareViaLinkedIn}>
                          <img className="img-fluid mr-2" src={linkedin} width="20px" height="20px" alt="sad" /> LinkedIn
                        </Dropdown.Item>
                        <Dropdown.Item onClick={copyToClipboard}>
                          <img className="img-fluid mr-2" src={copydata} width="20px" height="20px" alt="sad" /> Copy URL
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                  </div>

                  <button onClick={(e) => addItemToWishlist(e, product)} className="watch">
                    <LikeIcon
                      stroke={isProductPresentInWishlist(product) ? "red" : "#627284"}
                      fill={isProductPresentInWishlist(product) ? "red" : "#627284"}
                      className="d-block mx-auto eye"
                    />
                  </button>
                </div>
                ...
                <div className="product-info">
                  <p className="product-categorytwo"><a className="section" href={`/product-category/${product?.category_slug}`} target="_blank">
                    {product.category_name}
                  </a></p>

                  <p className="product-categorytwo">
                    By:<span className="product-company">
                      <a className="section" style={{ color: "#e75204" }} href={`/product-brands/${product?.brand_name}`} target="_blank">
                        {product.brand_name}
                      </a></span> </p>
                  ...
                  <div className="d-flex">
                    ...
                    <p className="productrate align-self-center">{product?.ratingCount?.average}</p>
                    {product?.ratingCount?.totalReviews == 0 && product?.ratingCount?.totalReviews == 0 ? (
                      <>
                        <p className="reviewrate align-self-center">Be A First Reviewer</p>
                      </>
                    ) : (
                      <>
                        <p className="reviewrate align-self-center"
                          style={{ cursor: "pointer" }}
                          onClick={handleOpenReviewTab}>{product?.ratingCount?.totalReviews} Ratings & {product?.ratingCount?.totalReviews} Reviews</p>
                      </>
                    )}
                  </div>
                  {product.mrp == product.final_price ? (
                    <>
                      <p className="product-categorytwo">
                        MRP: <span className="strike" style={{ textDecoration: "none" }}>₹ {Number(product.mrp).toFixed(2)}</span>
                      </p>
                    </>
                  ) : (
                    <>
                      <p className="product-categorytwo">
                        MRP: <span className="strike">₹ {Number(product.mrp).toFixed(2)}</span>
                      </p>
                    </>
                  )}
                  ...
                  <div className="d-flex">
                    <p className="price">
                      Price:<span className="price-money">₹ {Number(product.final_price).toFixed(2)}</span>
                    </p>

                    <div className={product.discount_percent > 0 || product.discount_amount !== 0 ? "price-radius" : ""}>
                      {product.discount_percent > 0 ? (
                        <p className="price-off mb-0">-{Number(product.discount_percent)} % </p>
                      ) : (
                        product.discount_amount !== 0 && (
                          <p className="price-off mb-0">{Number(product.discount_amount)} ₹</p>
                        )
                      )}
                    </div>

                    <p className="saved align-self-center">You Saved ₹ {Number(product.mrp - product.final_price).toFixed(2)}</p>
                  </div>
                  ...
                  <ul className="list-stock">
                    <li className="stock"
                      style={{
                        color: product.show_stock == 1 && product && product.stock_status == "Out Stock"
                          ? 'red' : 'green'
                      }}>
                      {/* {product?.show_stock == 1 && product?.stock_status == "Out Stock"
                       ? 'Out Of Stock' : 'In Stock'} */}
                      {product?.show_stock == 1 ? product?.stock_status == "Out Stock" ? "Out Of Stock" : "In Stock" : ""}

                    </li>
                  </ul>
                  {product.size_chart !== "null" && product.size_chart !== "undefined" && (
                    <>
                      <>
                  ...
                  <div className="d-flex">
                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap' }}>
                      {product?.product_type === 'variant' && (
                        <div className="moneycard active" style={{ marginRight: '10px', marginBottom: '10px' }}>
                          <a>{product.brand_size}</a>
                        </div>
                      )}
                      {product.variants?.length > 0 && (
                        product.variants.map((style, index) => (
                          <div key={index} className="moneycard noactive" style={{ marginRight: '10px' }}>
                            <Link
                              to={generateUrl(style)} // Adjust the URL generation function as needed
                  ...
                  {product && product.stock_status == "Out Stock" ? (
                    ...
                    <div className="mt-2 ">
                      ...
                      {product?.show_stock == 1 && product?.back_order_quantity < 10 && (
                        <p class="all-taxes">Only {product.back_order_quantity} Available</p>
                      )}
                      <div
                        id="sort-section"
                        ...
                        ? (
                          <>
                            ...
                            >
                              ...
                              {isProductPresentInCart(product) ? "Add to Cart" : "Add to Cart"}
                            </button>
                          </>
                        ) : (
                          <>
                        ...
                        ? (
                          <>
                            <button
                              ...
                              style={{ opacity: "0.6" }}
                            >
                              <FontAwesomeIcon className="mr-2" icon={faGem} size="lg" style={{ color: "#ffffff", }} />
                              Buy Now
                            </button>
                          </>
                        ) : (
                          <>
                            ...
                            >
                              <FontAwesomeIcon className="mr-2" icon={faGem} size="lg" style={{ color: "#ffffff", }} />
                              Buy Now
                              <span style={{ fontSize: "8px" }}>Power By Shiprocket</span>
                            </button>
                        ...
                        <div className="d-flex justify-content-between">
                          <p className="deliveraddress mb-0">
                            <img
                              ...
                              alt="map"
                            />
                            <input type="text" onChange={(e) => setPinCode(e.target.value)} placeholder="Enter Pin code" />
                          </p>
                          <a href="javascript:void(0)" onClick={handlePinCode} className="change align-self-center">
                            Check
                          </a>
                        </div>
                      </div>

                      <p className="free-ship">{possibleDeliveryData && `Delivery by ${possibleDeliveryData.date}`} <span className="right-border"></span>
                        <span className="freeship" onClick={openShippingChargesModal}
                          style={{ cursor: "pointer" }}  >{possibleDeliveryData && possibleDeliveryData.shipping}</span>
                      </p>
                      {openShippingCharges && possibleDeliveryData && (
                        <div className="modal-overlay mb-3" onClick={closeShippingChargesModal}>
                          <div className="modal-content" onClick={e => e.stopPropagation()}>
                            <p className="highlights mb-2 mt-3" style={{ textAlign: "center" }}>Shipping Charges</p>
                            <ul>
                              <li>₹1 - ₹199: ₹75</li>
                              <li>₹200 - ₹399: ₹55</li>
                              <li>₹400 - ₹599: ₹45</li>
                            ...
                            <div style={{ textAlign: "center" }}>
                              <Button
                                style={{
                                  color: "#fff", marginTop: "-10px", cursor: "pointer", backgroundColor: "#e75204", maxWidth: "100px", margin: "15px"
                                }}
          ...
          <div className="">
            ...
            <div className="row mt-4 mx-lg-0">
              <div className="tab-content col-lg-12 px-lg-0 mb-4" id="productpagetabs">
                <Tabs
                  ...
                  <Tab eventKey="details" title={<h3>Details</h3>}>
                    <div className="tab-pane mt-0" id="details">
                      ...
                      {product.description !== 'null' && (
                        <div className="dynamic-content" dangerouslySetInnerHTML={{ __html: product.description }}></div>
                      )}
                      <h4 className="details-heading">Ingredients</h4>

                      {product.key_ingredients !== 'null' && (
                        <div className="dynamic-content">
                          <p className="details-subheading">Key Ingredients:</p>
                          <div dangerouslySetInnerHTML={{ __html: product.key_ingredients }}></div>
                          <br />
                        </div>
                      )}
                      ...
                      {product.other_ingredients !== 'null' && (
                        <div className="dynamic-content">
                          <p className="details-subheading">Other Ingredients:</p>
                          <div dangerouslySetInnerHTML={{ __html: product.other_ingredients }}></div>
                          <br />
                        </div>
                      )}
                      ...
                      {product.directions_of_use !== 'null' && (
                        <div className="dynamic-content">
                          <h5 className="details-subheading">Directions for use</h5>
                          <div dangerouslySetInnerHTML={{ __html: product.directions_of_use }}></div>
                          <br />
                        </div>
                      )}

                      {product.feeding_table !== '<p>NA</p>' && product.feeding_table !== '<p>na</p>' && product.feeding_table !== 'NA' && product.feeding_table !== 'na' && (
                        <div className="dynamic-content">
                          <h5 className="details-subheading">Feeding Table</h5>
                          <div dangerouslySetInnerHTML={{ __html: product.feeding_table }}></div>
                          <br />
                        </div>
                      )}
                      ...
                      {product.safety_information !== 'null' && (
                        <div className="dynamic-content">
                          <h5 className="details-subheading">Safety Information</h5>
                          <div dangerouslySetInnerHTML={{ __html: product.safety_information }}></div>
                          <br />
                        </div>
                      )}

                      {product.product_benefits !== '<p>NA</p>' && product.product_benefits !== '<p>na</p>' && product.product_benefits !== 'NA' && product.product_benefits !== 'na' && (
                        <div className="dynamic-content">
                          <h4 className="details-subheading">Product Benefits</h4>
                          <div dangerouslySetInnerHTML={{ __html: product.product_benefits }}></div>
                          <br />
                        </div>
                      )}
                      ...
                      {typeof product.special_features !== 'string' && (
                        <div className="dynamic-content">
                          <h4 className="details-subheading">Special Features</h4>
                          <div dangerouslySetInnerHTML={{ __html: product.special_features }}></div>
                          <br />
                        </div>
                      )}
                      ...
                      >
                        <h4 className="details-heading mt-3 mb-3">Additional Information</h4>
                        ...
                        <table className="woocommerce-product-attributes shop_attributes table table-striped">
                          <tbody>
                            <tr className="woocommerce-product-attributes-item woocommerce-product-attributes-item--weight">
                              ...
                              <td className="woocommerce-product-attributes-item__value">{product.weight_kg} kg</td>
                            </tr>
                            ...
                            {typeof product.importer_name_and_address_with_pincode !== 'string' && (
                              <tr className="woocommerce-product-attributes-item woocommerce-product-attributes-item--attribute_pa_packer-details">
                                <th className="details-subheading woocommerce-product-attributes-item__label">
                                  Importer Details
                                </th>
                            ...
                            <tr className="woocommerce-product-attributes-item woocommerce-product-attributes-item--attribute_pa_expires-on-or-after">
                              ...
                              <td className="woocommerce-product-attributes-item__value">
                                {(() => {
                                  ...
                                  futureDate.setDate(futureDate.getDate() + product.expires_in_days);
                      ...
                      {product.product_video && product.product_video !== 'null' && (
                        <div>
                          ...
                          {product?.faqs.map((faq) => (
                            <Accordion.Item eventKey={faq.id.toString()} key={faq.id}>
                              ...
                              <div
                                ...
                                onClick={() => handleToggle(faq.id.toString())}
                              >
                                <h4>{faq.faq}</h4>
                                {/* Arrow icon that rotates based on the activeKey */}
                                <span className={`arrow-icon ${activeKey === faq.id.toString() ? 'open' : ''}`}>
                                  ▼
                                </span>
                              </div>
                      ...
                      <div>
                        <div className="row">
                          <div className="col-lg-6">
                            ...
                            <div className="d-flex">
                              <Rating name="simple-controlled" readOnly value={product?.ratingCount?.average} />
                              <p className="reviewrating align-self-center">{product?.ratingCount?.average}</p>
                            </div>

                            <p className="details-subheading">{`Based on ${product?.ratingCount?.totalReviews} Ratings`}</p>

                            <p className="details-para">
                              Weighted average based on user credibility on Cureka
                            </p>
                          </div>

                          <div className="col-lg-6">
                            <h4 className="details-heading">What Customers say</h4>
                            {product?.ratingCount?.totalCustomerRating.map((rating, i) =>
                              <div className={`row ${key === 0 && 'mt-5'} mb-4`} key={i}>
                                <div className="col-lg-2 align-self-center">
                                  <p className="mb-0 stars">{rating.name}</p>
                                </div>

                                <div className="col-lg-8 align-self-center" id="progressreviews">
                                  <div className="progress">
                                    <div
                                      className={`progress-bar ${i === 4 ? 'bg-danger' : 'bg-success'} } `}
                                      role="progressbar"
                                      aria-valuenow="70"
                                      aria-valuemin="0"
                                      aria-valuemax="100"
                                ...
                                <div className="col-lg-2 align-self-center">
                                  <p className="mb-0 stars">{rating.count}</p>
                                </div>
                              </div>
                            )}
                          </div>
                        </div>
                        {product.product_reviews && product.product_reviews.map((review, h) =>
                          <div className="address-two" key={h}>
                            <div className="d-flex">
                              <Rating readOnly name="simple-controlled" value={review.rating} />
                              <p className="productrate align-self-center">{review.rating}</p>
                            </div>
                            ...
                            <p className="genuine-name">
                              {review.created_by},
                              <span className="genuine-location">{review.time}</span>
                            </p>
                          </div>
                        )}
                        <div className="load-link">
                          {removedProductReview.length > 0 && <a className="loadmore" onClick={loadMoreReviews}>Load more</a>}
                        </div>
                      </div>
                    </div>
                  </Tab>
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <h2 className="details-heading mt-3 mb-3">Suggested Products</h2>
                    <div className="container-fluid p-0" id="new-arrivals">
                      <CarouselSlider settings={{ slidesToShow: isMobile ? 2 : 4 }}>
                        {!!newArrivals?.length &&
                          newArrivals?.map((product) => {
                            let product_front_tp_image
                            if (product?.product_images) {
                              product_front_tp_image = product?.product_images[0].image
                            } else {
                              product_front_tp_image = noproduct
                            }
                            console.log(product.product_id)
                            return (
                              <div key={product.product_id} className="item mr-3">

                                <div className="arrivals card">
                                  <div className="d-flex flex-nowrap justify-content-between">
                                    <div className="sale d-lg-block d-none">
                                      {product.discount_percent > 0 ? (
                                        <p className="sale-heading">-{Number(product.discount_percent)} % </p>

                                      ) : (
                                        product.discount_amount !== 0 && (
                                          <p className="sale-heading"> {product.discount_amount} ₹ </p>
                                        )
                                      )}
                                    </div>
                                    <a
                                    ...
                                    <div className="cart-icons align-self-start">
                                      <div className="watch position-relative">
                                        <a href={generateUrl(product)} target="_blank">
                                          <img
                                            src={eye}
                                            width="10px"
                                            height="10px"
                                      ...
                                      >
                                        <LikeIcon
                                          stroke={
                                            isProductPresentInWishlist(product) ? "red" : "#627284"
                                          }
                                          fill={
                                            isProductPresentInWishlist(product) ? "red" : "#627284"
                                          }
                                  ...
                                  <div className="product-text">
                                    <p className="product-category"><a className="section" href={`/product-category/${product?.category_slug}`} target="_blank">{`${product.category_name}`}</a></p>
                                    <a
                                    ...
                                    <div className="rating  d-lg-flex d-none">
                                      <p className="rating-number">
                                        {product && product.product_reviews.length > 0 ? (
                                          (product && product.product_reviews.length > 0
                                            ? (product.product_reviews.reduce((acc, review) => acc + (review.rating || 0), 0) / product.product_reviews.length)
                                            : "0")) : (
                                          "0"
                                        )}
                                      </p>
                                  ...
                                  <div className="d-lg-flex d-flex-column justify-content-between align-items-center">
                                    <div className="price d-flex d-lg-block">
                                      {product.mrp == product.final_price ? (
                                        <>
                                          <p style={{ textDecoration: "none" }} className="discount">&#8377; {product.mrp}</p>
                                          <p className="product-price">&#8377; {product.final_price}</p>
                                        </>
                                      ) : (
                                        <>
                                          <p className="discount">&#8377; {product.mrp}</p>
                                          <p className="product-price">&#8377; {product.final_price}</p>
                                        </>
                                      )}
                                    </div>
                                        ...
                                        ? (
                                          <>
                                            <div className="d-flex-column pb-0 pb-lg-5">
                                              ...
                                              >
                                                {product.show_stock == 1 && product && product.stock_status == "Out Stock"
                                                  ? 'Out Of Stock' : <>&nbsp;</>}
                                              </p>
                                              <button
                                                className="text-decoration-none align-items-center justify-content-center jus w-100 d-flex cart"
                                          ...
                                          <>
                                            ...
                                            <div className="d-flex-column pb-0 pb-lg-5">
                                              <p className="text-center"
                                                style={{ color: product && product.stock_status == "Out Stock" ? 'red' : '', fontSize: "10px" }}
                                              >
                                                {product && product.stock_status == "Out Stock"
                                                  ? <>&nbsp;</> : <>&nbsp;</>}
                                              </p>

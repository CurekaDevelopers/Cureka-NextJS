...
import orders from "../assets/images/order1.png";
              ...
              <div className="d-flex-column justify-content-center">
                ...
                <div className="d-lg-flex d-flex-column">
                  ...
                  <div className="card align-self-center">
                    ...
                    <img className="img-fluid mx-auto" src={orders} width={73} height={80} alt="order1" />

                  </div>

                  <div className="product-details align-self-center">

                    <h2 className="product-heading">Enfamil A+ Follow Up Formula Stage 2 (6-12 Months), 400g</h2>
                ...
                <div className="review-products">
                  ...
                  <div className="form-group">
                    ...
                    <label className="blog-heading" for="title">Title</label>

                    <input className="form-control" type="text" id="title" name="title" placeholder="What's most important to know?" />

                  </div>

                  <div className="form-group">

                    <label className="blog-heading" for="review">Review this product</label>

                    <textarea className="form-control" style={{ height: "99px" }} type="text" id="review" name="review"  rows="8" col="3" placeholder="What did you like or dislike?"></textarea>
                  ...
                  <div className="submit-btn pt-3">
                    ...
                    <a href="#" className="text-decoration-done rate-btn">Submit</a>

        ...
        <div className="container">
          ...
          <div className="success">
            ...
            <p className="your-order-para">
              Thank you for shopping with us! Your Order has been successfully placed, and we are excited to help you on your journey to better health and wellness</p>

            <Link to={pagePaths.myOrders} className="text-decoration-none track-btn">
              Track Order
            </Link>
          </div>
        </div>

...
export default function FasterOrder() {
  ...
  const handlePostRequest = async () => {
    try {
      const response = await axios.post(`${env.REACT_SERVER_BASE_URL}/faster/fasterCheckout`, {
        order_id: oid,
      });
      ...
      <div className="container-fluid px-0">
        <div className="container">
          <div className="d-flex home-back-section">
            ...
            <p className="section mb-0 ml-3">/ &nbsp;&nbsp;&nbsp;Faster Checkout</p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="success-space">
            {order && (
              <img
                ...
                src={order.order_placed_status == orderPlacedStatus.PLACED ? success : error}
                width="181px"
                height="164px"
                alt={order.order_placed_status == orderPlacedStatus.PLACED ? "Success" : "Error"}
              />
            )}
          </div>
          ...
          <div className="success">
            ...
            {order?.order_placed_status == "Your Order Placed" &&
              <Link to={pagePaths.trackOrder} className="text-decoration-none track-btn align-center">
                Track Order
              </Link>
            }
            {order?.order_placed_status == undefined &&
              <a href="http://frontend.cureka.com/" className="text-decoration-none track-btn align-center" target="_blank" rel="noopener noreferrer">
                Continue shopping
              </a>
            }

...
import sellwithus_mobile from "../assets/images/sellwithus-mobile.png";
...
import "../css/home.css";
import {
  addProductToCart, addProductToWishlist, deleteProductFromWishlist,
  fetchBlogsList,
  fetchBrands,
  fetchCuratedAdds,
  fetchHomePage,
...
import PopupModal from "./Header/HomePopup";
...
export default function Home() {
  ...
  const { brands, singleAdds, multipleAdds, curatedAdds: { CURATED, YOURSELF }, healthPage } = useSelector((state) => state.admin);
  ...
  const decodedData = decodeHtmlEntities(healthPage && healthPage[1] && healthPage[1].content); // Decode HTML entities
  ...
  //   // Chunk the items into arrays of four
  ...
  //                     <p className="reviewrating align-self-center">{item.rating}</p>
  //                   </div>
  //                   <h2 className="review-heading">{item.title}</h2>
  //                   <p className="review-para">
  //                     {item.comments}
  //                   </p>
  //                   <div className="d-flex">
  //                     <div className="top-border align-self-end"></div>
  //                     <p className="name">{item.created_by}</p>
  //                   </div>
  ...
  const MyCoupons = ({ citems }) => {
    ...
    return (
      <Carousel showArrows={false} showStatus={false} autoPlay={true} showThumbs={false}>
        {couponChunks.map((chunk, index) => (
          <div key={index} className="d-flex justify-content-between" id="coupons">
            {chunk.map((coupon) => (
  ...
  const hschema = {
    ...
    "mainEntity": {
      ...
      "name": "Home",
      "description": "Cureka is one of India's leading online stores for hair, skin, nutrition products, and healthcare devices. We have a wide range of products.",
      "image": {
        "@type": "ImageObject",
    ...
    <>
      <Helmet>
        ...
        <meta
          ...
          content="Cureka is one of India's leading online stores for hair, skin, nutrition products, and healthcare devices. We have a wide range of products."
        />
        <meta name="twitter:image" content="https://frontend.cureka.com/src/assets/images/logo.svg" />
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-TG8R4ZPTTZ"></script>
        <script
      ...
      <div className="container">
        ...
        <h1 className="doctors-heading mt-2 font-weight-bold text-center">Cureka: India’s leading Online Healthcare Platform</h1>
        <div className="product-carousel">
          <div className="d-flex justify-content-between">
            <h2 className="doctors-heading mt-0">New Arrivals</h2>
            <Link className="text-decoration-none align-self-center" to={pagePaths.newArrivals} target="_blank">
          ...
          <div className="row">
            <div className="col-lg-12">
              <div className="container-fluid p-0" id="new-arrivals">
                <CarouselSlider settings={{ slidesToShow: isMobile ? 2 : (isPhone ? 3 : 4) }}>
                  {!!newArrivals?.length &&
                    newArrivals?.map((product) => {
                      let product_front_na_image
                      if (product?.product_images) {
                        product_front_na_image = product?.product_images[0].image
                      } else {
                            ...
                            <div className="d-flex flex-nowrap justify-content-between">
                              <div className="sale d-lg-block d-none">
                                {product.discount_percent > 0 ? (
                                  ...
                                  <div style={{ backgroundColor: product.discount_amount !== 0 ? 'sale-heading' : 'white' }}>
                              ...
                              <div className="cart-icons align-self-start">
                                <div className="watch position-relative">
                                  <a href={generateUrl(product)} target="_blank"> <img
                                    src={eye}
                                    width="10px"
                                    height="10px"
                            ...
                            <div className="product-text">
                              ...
                              <div className="rating  d-lg-flex d-none">
                                <p className="rating-number">
                                  {product && product.product_reviews && product.product_reviews?.length > 0 ? (
                                ...
                                product?.show_stock == 1 || product && product.stock_status == "Out Stock" ? (
                                  <>
                                    <div className="d-flex-column pb-0 pb-lg-5">
                                      ...
                                      >
                                        {product?.show_stock == 1 && product && product.stock_status == "Out Stock" ? 'Out Of Stock' : <>&nbsp;</>}
                                      </p>
                                      <button
                                  ...
                                  <>
                                    ...
                                    <div className="d-flex-column pb-0 pb-lg-5">
                                      <p className="text-center"
                                        style={{ color: product?.show_stock == 1 && product && product.stock_status == "Out Stock" ? 'red' : '', fontSize: "10px" }}
                                      >
                                        {product?.show_stock == 1 && product && product.stock_status == "Out Stock" ? <>&nbsp;</> : <>&nbsp;</>}
                                      </p>
                                      <button
        ...
        {CURATED && <div className="row">
          {CURATED.map((curatedAdd, i) =>
            <div className="col-lg-3 col-6 mb-3 mb-lg-0" key={i}>
              <a className="text-decoration-none" onClick={() => navigate(`/${curatedAdd?.url}`)}>
                <img
        ...
        <div className="row">
          <div className="col-lg-3 col-6">
            <Link className="text-decoration-none" to={pagePaths.shopByAge + '?min=0&max=5'} target="_blank">
          ...
          <div className="col-lg-3 col-6">
            <Link className="text-decoration-none" to={pagePaths.shopByAge + '?min=5&max=18'} target="_blank">
              <img
                src={age2}
                width="320px"
                height="159px"
          ...
          <div className="col-lg-3 col-6">
            <Link className="text-decoration-none" to={pagePaths.shopByAge + '?min=18&max=50'} target="_blank">
              <img
                src={age3}
                width="320px"
                height="280px"
          ...
          <div className="col-lg-3 col-6">
            <Link className="text-decoration-none" to={pagePaths.shopByAge + '?min=50&max=100'} target="_blank">
              <img
                src={age4}
                width="320px"
                height="159px"
        ...
        <div className=" product-carousel">
          <div className="d-flex justify-content-between">
            ...
            <Link className="text-decoration-none align-self-center" to={pagePaths.topPicks} target="_blank">
              <p className="all-deals">All Deals</p>
            </Link>
          </div>
        ...
        {YOURSELF && <div className="row">
          {YOURSELF.map((yourself, i) =>
            <div className={i > 3 ? "col-lg-4 col-6" : "col-lg-4 col-6"} key={i} >
        ...
        <div className="brands mt-0">
          <div className="row">
            <h2 className="doctors-heading mt-4">Shop All {brands ? brands.length : 0} Brands</h2>
          </div>

          <div className="row" id="topbrands">
            <div className="col-lg-12">

              <CarouselSlider settings={{ slidesToShow: isMobile ? 2 : (isPhone ? 3 : 6), }}>
                {!!brands?.length &&
                  brands?.map((brandformat, index) =>
                    <div key={brandformat.id}>
                      <div className="item mr-3" key={index}>
                        <p style={{ width: '180px', cursor: 'pointer' }} className="text-decoration-none" href="" onClick={() => handleConcernsProducts(brandformat.name)}>
                          <img
        ...
        <div className="d-flex justify-content-between">
          ...
          <a className="text-decoration-none align-self-center" href="blogs" target="_blank">
            <p className="view-all">View All</p>
          </a>
        </div>

        <div id="blog-card">
          <CarouselSlider settings={{ slidesToShow: isMobile ? 1 : (isPhone ? 2 : 3) }}>
            {blogHome?.length &&
              blogHome?.map((blog, blogIndex) =>
                <div key={blogIndex} className="d-lg-flex justify-content-between">
                  <div key={blogIndex} className="item mr-3">
                    <Link to={`/blogs/${blog.url}`} key={blog.id} className="text-decoration-none banner-container"
                      href="blogdetails">
                      <div className="blog-img">
                        <img src={blog.thumbnail_image} width="480px" height="226px" className="img-fluid"
                          alt="blog1" />

                        <div>
                          <div className="blog-card pb-0">
                            <div className="d-flex">
                              <FontAwesomeIcon style={{ "color": "gray", "width": "14px", "height": "14px" }} icon={faUser}
                              ...
                              <FontAwesomeIcon style={{ "color": "gray", "width": "14px", "height": "14px" }} icon={faCalendar}
                                className="mr-2" size="lg" />

                              <p className="user mb-0">{dayjs(blog.blog_date).format("DD MMMM, YYYY")}</p>
                            </div>
        ...
        <div className="customers">
          ...
          <div id="customers-carousel">
            <CarouselSlider settings={{ slidesToShow: isMobile ? 1 : (isPhone ? 2 : 4), }}>
              {commonHome?.length &&
                commonHome?.map((homedata, itemIndex) =>
                  <div key={homedata.productid} className="d-lg-flex justify-content-between">
                    <div key={itemIndex} className="item mr-3">
                      <div className="card">
                        <div className="customer-card">
                          <img
                          ...
                          />
                          <div className="d-flex">
                            <Rating readOnly name="simple-controlled" value={homedata.rating} />
                            <p className="reviewrating align-self-center">{homedata.rating}</p>
                          </div>
                          ...
                          <div className="d-flex">
                            <div className="top-border align-self-end"></div>
                            {homedata.created_by ? homedata.created_by.replace(" null", "") : ""}
                          </div>
        ...
        <div className="health-care">
          ...
          <div className="row mt-lg-5 mt-3">
            ...
            <div className="col-lg-6 mt-lg-0 mt-3 align-self-center">
              <h3 className="motive-heading">{healthPage && healthPage[1] && healthPage[1].heading}:</h3>

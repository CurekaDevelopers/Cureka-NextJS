...
import contactus_banner from "../assets/images/contactus_banner.png";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Contact us to know more about our health care products, your order details and more. Also contact us through our WhatsApp chatfeature." />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Cureka" />
        <meta property="og:description" content="Contact us to know more about our health care products, your order details and more. Also contact us through our WhatsApp chatfeature." />
              ...
              <div className="card">
                ...
                <p className="contact-address">
                  ...
                  <span className="contact-subaddress">
                    {" "}
                    75/1, Alagar Kovil Main Rd, Surveyor Colony, Madurai, Tamil Nadu 625007
                  </span>
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-4 mt-3 mt-lg-0">
              <div className="card">
                <div className="d-flex-column my-auto">
                  ...
                  <a href="mailto:info@cureka.com" className="contact-address d-block mx-auto">info@cureka.com</a>
                </div>
              </div>
            </div>
            ...
            <div className="col-lg-4 mt-3 mt-lg-0">
              <div className="card">
                <div className="d-flex-column my-auto">
                  ...
                  <a href="tel:+91 9655928004" className="contact-address d-block mx-auto">+91 96559 28004</a>
                </div>
              </div>
            </div>
          </div>

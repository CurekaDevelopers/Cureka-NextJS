...
export default function SellWithUsForm() {
    ...
    const formik = useFormik({
        ...
        validationSchema: Yup.object({
            ...
            business_volume: Yup.string().required("Annual Business Volume is required"),
            categories: Yup.array().of(Yup.string().required("Annual Business Volume is required")),

            catalog: Yup.string().url("Invalid URL").optional("Current Catalog Link is required"),
                                    ...
                                    <div className="address-two">
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    ...
                                                    {formik.touched.mobile_number && formik.errors.mobile_number ? (
                                                        <small className="text-danger">{formik.errors.mobile_number}</small>
                                                    ) : null}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    <label className="email" htmlFor="products">
                                                        Number of Products<span className="required-star">*</span>
                                                    </label>
                                                    <input
                                                        className="form-control"
                                                        type="number"
                                            ...
                                            <div className="col-lg-12">
                                                <div className="form-group">
                                                    <label className="email" htmlFor="volume">
                                                        Annual Business Volume<span className="required-star">*</span>
                                                    </label>
                                                    ...
                                                    {formik.touched.business_volume && formik.errors.business_volume ? (
                                                        <small className="text-danger">{formik.errors.business_volume}</small>
                                                    ) : null}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    ...
                                                    {formik.touched.catalog && formik.errors.catalog ? (
                                                        <small className="text-danger">{formik.errors.catalog}</small>
                                                    ) : null}
                                                </div>
                                            </div>
                                            <div className="col-lg-6">
                                                <div className="form-group">
                                                    ...
                                                    {formik.touched.brands && formik.errors.brands ? (
                                                        <small className="text-danger">{formik.errors.brands}</small>
                                                    ) : null}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-lg-12">
                                                <div className="form-group">
                                                    ...
                                                    {formik.touched.categories && formik.errors.categories ? (
                                                        <small className="text-danger">{formik.errors.categories}</small>
                                                    ) : null}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row">
                                            <div className="col-lg-12 mt-3">
                                                <button type="submit" className="text-decoartion-none rate-btn">
                                                    Submit
                                                </button>
                                            </div>
                                        </div>

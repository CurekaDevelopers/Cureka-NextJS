...
export const fetchBrands = () => async (dispatch) => {
  try {
    ...
    dispatch(setBrands([]));
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while fetching brands!",
    );
...
export const fetchArticleType = () => async (dispatch) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while fetching article type!",
    );
...
export const fetchPreferenceType = () => async (dispatch) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while fetching preference type!",
    );
...
export const fetchStandardSizeList = (id) => async (dispatch) => {
  try {
    ...
    const standardSizeList = await api.get(apiUrls.standardSizeList + '?artical_type_id=' + id);
...
export const fetchProductsAdmin = () => async (dispatch) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while fetching products!",
    );
...
export const deleteProducts = (id, successCallback) => async (/*dispatch*/) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while deleting blogs.",
    );
...
export const updateBrand =
  (id, { name, image, description, status, brand_image, metaTitle, metaDescription }, successCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          name,
...
export const createBrand =
  ({ name, image, description, status, brand_image, metaTitle, metaDescription }, successCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          name,
...
export const fetchConcernsProducts = (queryParams = {}) => async (dispatch) => {
  console.log(queryParams, 'queryParams')
  try {
    const concerns = await api.get(apiUrls.concernsProduct + '/' + queryParams?.item);
...
export const fetchConcernsProductsForBrand = (queryParams = {}) => async (dispatch) => {
  console.log(queryParams)
  try {
    const concerns = await api.get(apiUrls.brandProduct + '/' + queryParams?.item);
    dispatch(setConcernsProduct(concerns.data || []));
...
//brandwiseproducts
export const fetchProductsForBrand = (queryParams = {}) => async (dispatch) => {
  console.log(queryParams)
  try {
    const concerns = await api.get(apiUrls.brandProduct + '/' + queryParams.
      brandSlug);
    dispatch(setConcernsProduct(concerns.data || []));
...
export const fetchApproveBlogsCommentList = async (id) => {
  try {
    ...
    toast.error(
      `Something went wrong while fetching blog: ${error?.response?.data?.error || error.message}`,
    );
...
export const createConcern =
  ({ name, image, description, status, metaTitle, metaDescription }, successCallback, failureCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          name,
...
export const updateConcern =
  (id, { name, image, description, status, metaTitle, metaDescription }, successCallback, failureCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          name,
...
export const articleCategory = ({ name, artical_type_id, status }, successCallback, failureCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const updateArticleType = (id, { name, status }, successCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const deleteArticleType = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
//preference add 
export const preferenceCategory = ({ name, artical_type_id, status }, successCallback, failureCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const editPreferenceType = (id, { name, artical_type_id, status }, successCallback, failureCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
//preference delete 
export const deletePreferenceType = (recordToDelete, successCallback) => async () => {
...
//end
export const deleteArticalType = (recordToDelete, successCallback) => async () => {
  const { id } = recordToDelete
  console.log("successCallback", successCallback)
  try {
...
export const addStandardSize = ({ name, artical_type_id, status }, successCallback, failureCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const editStandardSize = (id, { name, artical_type_id, status }, successCallback, failureCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const updateCategory = (id, { name, image, description, status, metaTitle, metaDescription }, successCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        name,
...
export const deleteCategories = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
export const createSubCategory =
  ({ category_name, category_id, name, image, description, status, metaTitle, metaDescription }, successCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          category_name,
...
export const updateSubCategory =
  (id, { category_name, category_id, name, image, description, status, metaTitle, metaDescription }, successCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          category_name,
...
export const deleteSubCategories = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
export const createSubSubCategory =
  ({ sub_category_name, category_id, sub_category_id, category_name, name, image, description, status, metaTitle, metaDescription }, successCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          sub_category_name,
...
export const updateSubsubCategory = (id, payload, successCallback) => async (dispatch) => {
  try {
...
export const deleteSubSubCategories = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
export const fetchListStandardSize = ({ id }) => async (dispatch) => {
  try {
    const response = await api.get(apiUrls.listStandardSize + '?artical_type_id=' + id);
...
export const updateSubSubSubCategory = (id, payload) => async (dispatch) => {
  try {
    const response = await api.put(apiUrls.updateSubSubSubCategory(id), payload);
    if (response.status === httpCode.SUCCESS) {
      dispatch(setSubSubSubCategories(response.data || []));
    }
  } catch (error) {
...
export const deleteSubSubSubCategories = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
export const deleteStandardSizeList = (id, successCallback) => async (/*dispatch*/) => {
  try {
...
export const fetchRatingAndReview = () => async (dispatch) => {
  try {
    ...
    const { data: { results = [] } } = ratingAndReview
    dispatch(setRatingAndReviews(results));
  } catch (error) {
    dispatch(setRatingAndReviews([]));
    toast.error(
      `Something went wrong while fetching review and ratings: ${error?.response?.data?.error || error.message}`,
    );
...
export const fetchBlogsListUserComment = (id) => async (dispatch) => {
  try {
    ...
    const blogs = await api.get(apiUrls.getBlogsListUserComments, { params: payload });
...
export const fetchProductBySlug = async (slug) => {
  try {
    ...
    toast.error(
      `Something went wrong while fetching product: ${error?.response?.data?.error || error.message
      }`,
    );
  ...
  (
    ...
    async (dispatch) => {
      try {
        ...
        dispatch(setBlogs([]));
        toast.error(
          `Something went wrong while updating blog: ${error?.response?.data?.error || error.message
          }`,
        );
...
export const blogCommentAction = ({ id, action }, successCallback) => async (dispatch) => {
  try {
    const payload = {
      blog_comment_id: id,
      action: action
    ...
    const response = await api.post(apiUrls.getBlogsUserCommentsAction, payload);
...
export const fetchHomePage = () => async (dispatch) => {
  try {
    ...
    if (response && response.data && response.data.data) {
      dispatch(setHomePage(response && response.data && response.data.data || {}));
    }
  } catch (error) {
...
export const deletePopup = async (id, successCallback) => {
  try {
    ...
    toast.error(isError && message || "Something went wrong while updating Coupon!");
  }
};
...
export const createOrder = async (data) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while creating order",
    );
...
export const getOrder = async (orderId) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong fetching order",
    );
  }
};
...
// Coupons
export const createCoupon = async (payload, successCallback, failureCallback) => {
  try {
...
export const updateCoupon = async (id, payload, successCallback, failureCallback) => {
  try {
...
export const createEmployee = ({ email, password, first_name, last_name, created_by, roles, status }, successCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        email,
...
export const updateEmployee = (id, { email, password, first_name, last_name, updated_by, roles, status }, successCallback) =>
  async (/*dispatch*/) => {
    try {
      const payload = {
        email,
...
export const updateBanner =
  (id, { name, image, description, status }, successCallback, failureCallback) =>
    async (/*dispatch*/) => {
      try {
        const payload = {
          name,
...
export const getpossibleDeliveryData = async ({ pickup_postcode, delivery_postcode, weight, cod = 1 }) => {
  const obj = {
    "email": "care@cureka.com",
    "password": "Wed@2024"
  }
  try {
    const shiprocketAuthToken = await axios.post(apiUrls.shipRocketAuth, obj, { "Content-Type": "application/json" });
    if (shiprocketAuthToken.status === httpCode.SUCCESS) {
      const response = await axios.get(apiUrls.shipRocketServiceability(pickup_postcode, delivery_postcode, weight, cod), { headers: { Authorization: `Bearer ${shiprocketAuthToken.data.token}`, "Content-Type": "application/json" } })
      if (response.status === httpCode.SUCCESS) {
        if (response.data.status === 200) {
          const filteredResponse = response.data.data.available_courier_companies.filter(
            (company) =>
              company.courier_company_id === response.data.data.recommended_courier_company_id
          );
          return filteredResponse[0];
        } else {
          // Handle cases where the `status` field is not 200
          toast.error(response.data.message || "No courier service available for the selected locations.");
          return null;
        }
      }
    }
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while estimating delivery date!",
    );
...
export const getAddressOnPincode = async (pincode) => {
  try {
    const response = await axios.get(apiUrls.getAddressOnPincode(pincode), { headers: { "Content-Type": "application/json" } })
    if (response.status === httpCode.SUCCESS) {
...
export const getAllFaqs = async () => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong fetching faq",
    );
  }
};
...
export const deleteFaqs = async (id, successCallback) => {
  try {
    ...
    toast.error(
      error?.response?.data?.error || error.message || "Something went wrong while deleting Faq.",
    );
...
// Single Add
export const createSingleAdd = async ({ image, url }, successCallback, failureCallback) => {
  const payload = {
    image: image,
    url: url
  }
...
export const updateSingleAdd = async (id, { image, url, updated_by, status }, successCallback, failureCallback) => {
  const payload = {
    image: image,
    url: url,
...
export const fetchSingleAdds = (status = "") => async (dispatch) => {
  try {
...
// Multiple Adds
export const createMultipleAdd = async ({ image, url }, successCallback, failureCallback) => {
  const payload = {
    image: image,
    url: url
  }
...
export const updateMultipleAdd = async (id, { image, url, updated_by, status }, successCallback) => {
  const payload = {
    image: image,
    url: url,
    updated_by: updated_by,
...
export const fetchMultipleAdds = (status = "") => async (dispatch) => {
  try {
...
// Curated Adds
export const createCuratedAdd = async ({ image, url, type, status, products }, successCallback) => {
  const payload = {
    image: image,
    url: url,
    type: type,
...
export const deleteCuratedAdd = async (id, successCallback, failureCallback) => {
  try {
...
export const updateCuratedAdd = async (id, { image, url, type, status, products, updated_by }, successCallback, failureCallback) => {
  const payload = {
    image: image,
    url: url,
    type: type,
...
export const fetchCuratedAdds = (status = "") => async (dispatch) => {
  try {

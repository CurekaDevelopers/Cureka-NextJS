...
export const apiUrls = {
  ...
  blogsApprovalList: (id) => `admin-blog-management/listApprovedComment?blog_id=${id}`,
  ...
  deleteStandardSizeList: (id) => `/admin-artical-type/deleteStandardSize/${id}`,
  ...
  fileUploadUrl: (category) => `/upload?category=${category || "uncategorized"}`,
  ...
  downloadSampleExcelFile: urlJoin(basePath, "import-products", "download-sample-excel-file"),
  downloadSampleExcelFileForImportProductImage: urlJoin(basePath, "import-products", "download-sample-product-image-excel-file"),
  downloadSampleExcelFileForImportProductPrice: urlJoin(basePath, "import-products", "download-sample-product-price-excel-file"),
  uploadProducts: urlJoin(basePath, "import-products", "import"),
  uploadProductsPriceExcelFile: urlJoin(basePath, "import-products", "productpricesimport"),
  uploadProductsOfferExcelFile: urlJoin(basePath, "import-products", "offerproductsimport"),
  downloadSampleExcelFileOffers: urlJoin(basePath, "import-products", "download-sample-product-offer-excel-file"),
  uploadProductsImageExcelFile: urlJoin(basePath, "import-products", "productimagesimport"),
  ...
  shipRocketServiceability: (pickup_postcode, delivery_postcode, weight, cod) => `https://apiv2.shiprocket.in/v1/external/courier/serviceability/?pickup_postcode=${pickup_postcode}&delivery_postcode=${delivery_postcode}&weight=${weight}&cod=${cod}`,
  shipRocketAuth: 'https://apiv2.shiprocket.in/v1/external/auth/login',
  getAddressOnPincode: (pincode) => `https://api.data.gov.in/resource/6176ee09-3d56-4a3b-8115-21841576b2f6?api-key=579b464db66ec23bdd000001cdd3946e44ce4aad7209ff7b23ac571b&format=json&filters%5Bpincode%5D=${pincode}`,

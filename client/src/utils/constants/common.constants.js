...
export const generateUrl = (product) => {
  if (product.url && product.url.includes("shop")) {
    ...
    let url = "/shop";
    if (product.category_slug !== null && product.category_slug !== undefined) {
      url = url + `/${product.category_slug}`;
    }
    if (product.sub_category_slug !== null && product.sub_category_slug !== undefined) {
      url = url + `/${product.sub_category_slug}`;
    }
    if (product.sub_sub_category_slug !== null && product.sub_sub_category_slug !== undefined) {
      url = url + `/${product.sub_sub_category_slug}`;
    }

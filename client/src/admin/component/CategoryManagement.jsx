...
const CategoryManagement = () => {
  ...
  const deleteCategory = async (categoryId) => {
    try {
      ...
      await api.delete(`your-api-endpoint/categorys/${categoryId}`); // Replace with your actual API endpoint
      ...
      <div className="inner_page profile_page">
        <div className="full_container">
          <div className="inner_container">
            <nav id="sidebar">
              <div className="sidebar_category_1">
              ...
              <div className="sidebar_category_2">
                <h4>General</h4>

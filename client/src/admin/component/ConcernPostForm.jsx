...
const ConcernPostForm = () => {
  ...
  const handleFormSubmit = async (e) => {
    ...
    formData.append("id", Math.round(Math.random() * 10));
    ...
    try {
      const response = await api.post("/concerns", formData, {
        headers: {
              ...
              <form onSubmit={handleFormSubmit}>
                <fieldset>
                  <div className="fields">
                    <label className="label_fields">Name: </label>
                    <input
                      type="text"
                      name="name"
                      value={name}
...
export default ConcernPostForm;

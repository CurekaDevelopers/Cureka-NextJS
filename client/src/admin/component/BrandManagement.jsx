...
import BrandPostForm from "./BrandPostForm";
...
const BrandManagement = () => {
  ...
  const deleteBrand = async (brandId) => {
    ...
    try {
      ...
      const response = await api.delete(`/delete-brand/${brandId}`);
      console.log(response, "del");
      if (response.status === 200) {
        setShow(true);
        setMsg(response.data.message);
        setBrandList(brandsList.filter((brand) => brand.id !== brandId));
      } else {
        setShow(false);
        setMsg(response.data.message);
      }
  ...
  const editBrand = async (brandId) => {
    ...
    try {
      // Perform the delete request
      await api.put(`/update-brand/${brandId}`); // Replace with your actual API endpoint
            ...
            <div id="content">
              ...
              <div className="mh-100">
                <Navbar bg="light" expand="lg">
                  <Container>
                    <Navbar.Brand href="#home">Create Brand</Navbar.Brand>
                ...
                <Container fluid>
                  <Row>
                    ...
                    >
                      ...
                      {createBrand ? (
                        <BrandPostForm sendDataToParent={handleDataFromChild} />
                      ) : (
                        <div>
                          <button

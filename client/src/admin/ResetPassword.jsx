...
import { env } from "../../../client/src/config/env.config";
import { pagePaths } from "../../../client/src/routes/constant";
...
const ResetPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`${env.REACT_SERVER_BASE_URL}/reset-password?token=${token}`, {  password,confirmPassword });

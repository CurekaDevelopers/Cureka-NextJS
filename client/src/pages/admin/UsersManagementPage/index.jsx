...
const UsersManagementPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`${env.REACT_SERVER_BASE_URL}/user/account/addfunds`, formData);
          ...
          return (
            <div>
              <Button
                ...
                onClick={() => handleShow(cell.row.original.mobile_number, cell.row.original.id)}>
                Add Money to Wallet
              </Button>
            </div>
          );
        ...
        <div>
          <Card className={styles.card}>
            ...
            {mappedConcerns?.length ? (
              ...
              <p className={styles.noRecordFoundMessage}>No Users found, please add new Orders.</p>
            )}
          </Card>

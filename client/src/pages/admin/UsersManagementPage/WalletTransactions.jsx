...
import { fetchAdminUsers, fetchUserWalletTransactions } from "../../../redux/action";
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                Cell: ({ cell }) => {
                    return <span className={styles.titleColumn}> {cell.row.original.transaction_type == "CREDIT" ? "Amount Credit" : "Amount Debit"}</span>;
                },
            },
            {
                Header: "Amount",
                accessor: "amount",
                Cell: ({ cell }) => {
                    return <span className={styles.titleColumn}> {cell.row.original.transaction_type == "CREDIT" ? "+" : "-"}
            ...
            },
            {
                ...
                accessor: "txn_date",
                Cell: ({ cell }) => {
                    return <span className={styles.titleColumn}>

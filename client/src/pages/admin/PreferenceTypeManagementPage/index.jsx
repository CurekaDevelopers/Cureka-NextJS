...
import { deletePreferenceType, fetchPreferenceType } from "../../../redux/action";
...
const PreferenceTypeManagementPage = () => {
  ...
  const onEdit = useCallback(
    (id, replay = 'edit') => {
      ...
      if (replay === 'replay') {
        navigate(pagePaths.adminCreatePreferenceType.replace(":id", id));
        return
      }
      navigate(pagePaths.adminCreatePreferenceEdit.replace(":id", id));
    },
    [navigate],
  );
  ...
  const rolesPermission = userRoles.filter(item => item.name == "Preference Type Management")
          ...
          <Card className={styles.card}>
            ...
            />
              <div className="ml-auto">
                {isAdminStatus == 1 ? (
                  <Link to={pagePaths.adminCreatePreferenceType}>

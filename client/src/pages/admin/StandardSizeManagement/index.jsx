...
import { deleteStandardSizeList, fetchListStandardSize } from "../../../redux/action";
...
const StandardSizeManagementPage = () => {
    ...
    const onEdit = useCallback(
        (tableId) => {
            const removeId = pagePaths.adminEditStandardArticalType.replace(":id", id)
                ...
                <div>
                    <Card className={styles.card}>
                        <div className={styles.cardHeader}>
                            ...
                            <Button className={styles.addButton} onClick={() => navigate(pagePaths.adminCreateStandardArticalType.replace(":id", id))}>
                        ...
                        {mappedSubSubSubcategories?.length ? (
                            ...
                            <p className={styles.noRecordFoundMessage}>
                                No standard artical types found, please add new standard artical type.
                            </p>
                        )}
                    </Card>
                </div>

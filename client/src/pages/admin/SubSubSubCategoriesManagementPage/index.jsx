...
import { deleteSubSubSubCategories, fetchSubSubSubCategories } from "../../../redux/action";
...
const SubSubSubCategoriesManagementPage = () => {
  ...
  const rolesPermission = userRoles.filter(item => item.name == "Sub Sub Sub Category")
        ...
        <div>
          <Card className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <div>
                {isAdminStatus == 1 ? (
                  <Link to={pagePaths.adminCreateSubSubSubCategory}>
            ...
            {mappedSubSubSubcategories?.length ? (
              ...
              <p className={styles.noRecordFoundMessage}>
                No Sub Sub Sub Categories found, please add new sub sub sub category.
              </p>
            )}
          </Card>
        </div>

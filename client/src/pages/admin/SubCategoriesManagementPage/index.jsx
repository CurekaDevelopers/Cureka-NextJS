...
import { deleteSubCategories, fetchSubCategories } from "../../../redux/action";
...
const SubCategoriesManagementPage = () => {
  ...
  const onEdit = useCallback(
    (id) => {
      navigate(pagePaths.adminCreateSubCategoryEdit.replace(":id", id));
    },
    [navigate],
  );
  ...
  const rolesPermission = userRoles.filter(item => item.name == "Sub Category")
          ...
          <Card className={styles.card}>
            ...
            <div className="d-flex">
              ...
              <div className="ml-auto">
                ...
                {isAdminStatus == 1 ? (
                  <Link to={pagePaths.adminCreateSubCategory}>

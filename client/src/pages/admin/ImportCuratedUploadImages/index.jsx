...
const ImportCuratedUploadImages = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            setLoading(true);
            const response = await api.post(apiUrls.uploadProductsOfferExcelFile, formData, {
                headers: {
            ...
            <div>
                <Card className={styles.card}>
                    ...
                    <Form className="mt-4">
                        ...
                        <Button disabled={loading} variant="primary" className="mt-3" onClick={handleUpload}>
                            Upload
                        </Button>
                    </Form>
                    {uploadProgress > 0 && (

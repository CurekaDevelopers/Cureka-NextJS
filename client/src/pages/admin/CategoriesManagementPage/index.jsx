...
const CategoriesManagementPage = () => {
  ...
  const onEdit = useCallback(
    (id) => {
      navigate(pagePaths.adminCreateCategoryEdit.replace(":id", id));
    },
    [navigate],
  );
  const rolesPermission = userRoles.filter(item => item.name == "Categories Management")
        ...
        <div>
          <Card className={styles.card}>
            ...
            />
              ...
              {isAdminStatus == 1 ? (
                 <Link to={pagePaths.adminCreateCategory}>

...
const AccountTab = () => {
  ...
  const handleSave = () => {
    ...
    if (!userDetails.mobile_number || !mobilePattern.test(userDetails.mobile_number)) {
      toast.error("Mobile number must be numeric and exactly 10 digits.");
      return;
    }
    setIsLoading(true);
    api.post(apiUrls.updateAccountDetails, userDetails).then((response) => {
      if (!response) {
        getAccountDetails();
      } else {
      ...
      toast.error(error && error && error.response && error.response.data && error.response.data.error)
  ...
  return (
    <>
      <Helmet>
        <title>My Account - Manage Orders, Shipping, and Personal Information | Cureka</title>
        <meta name="description" content="Access your account on Cureka to track orders, view order history, manage shipping addresses, and update personal information. Secure and personalized shopping made easy." />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Cureka" />
        <meta property="og:description" content="Access your account on Cureka to track orders, view order history, manage shipping addresses, and update personal information. Secure and personalized shopping made easy." />
            ...
            <div className="col-lg-12">
              ...
              <div className="row">
                <div className="col-lg-12 mt-3">
                  <button className="text-decoartion-none rate-btn" onClick={handleSave} disabled={isLoading}>
                    {isLoading ? (
                      <span>

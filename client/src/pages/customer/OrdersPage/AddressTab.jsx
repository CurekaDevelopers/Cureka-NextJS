...
import { Button, Modal, OverlayTrigger, ToggleButtonGroup, Tooltip } from "react-bootstrap";
...
import { fetchAddresses, getAddressOnPincode, updateUserAddress } from "../../../redux/action";
...
const AddressTab = () => {
  ...
  const formikAddShippingAddress = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const response = await axios.post(`${env.REACT_SERVER_BASE_URL}/addAddress`, values, {
          headers: {
  ...
  const handleSubmitDeleteAddress = async () => {
    ...
    await axios.put(`${env.REACT_SERVER_BASE_URL}/deleteAddress/${userAddressData && userAddressData.id}`,
      {},
      {
        headers: {
          'Content-Type': 'application/json',
  ...
  const handlePinCodeBlur = () => {
    getAddressOnPincode(formikAddShippingAddress.values.pincode).then((response) => {
      if (response) {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Easily add, edit, and manage your shipping addresses in your account at Cureka. Keep your delivery details up to date for a smooth shopping experience." />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Cureka" />
        <meta property="og:description" content="Easily add, edit, and manage your shipping addresses in your account at Cureka. Keep your delivery details up to date for a smooth shopping experience." />
              ...
              <div className="card p-3 rounded-2">
                <div className="row address-two row-gap-4 px-0">
                  <div className="d-flex justify-content-end">
                    <Button type='btn' style={{ width: "120px" }} onClick={handleAddresShow} className="text-decoration-none rate-btn mr-0" >Add Address</Button>
                  </div>
                  {address && address.length > 0 ? (
                        ...
                        <div className="card">
                          <div className="d-flex justify-content-between">
                            ...
                            <div className="d-flex">
                              <DeleteButton onClick={() => onDeleteButtonAddressClicked(item)} />
                              <div className="pencil mr-1">
                                <div className="d-flex" onClick={() => onEditAddressClicked(item)}>
                                  <img
                          ...
                          <div className="card-content">
                            ...
                            <p className="address-one">
                              {[item.address, item.landmark, item.pincode].filter(Boolean).join(", ")}
                            </p>
                    ...
                    <div>
                      <p className="price" style={{ textAlign: "center" }}>"No addresses were found."
                      </p>
                    </div>
                  )}
                </div>
                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        />
                        {formikShippingAddress.errors.name && formikShippingAddress.touched.name && (
                          <span className="error-text">{formikShippingAddress.errors.name}</span>
                        )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.mobile &&
                          formikShippingAddress.touched.mobile && (
                            <span className="error-text">{formikShippingAddress.errors.mobile}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.email &&
                          formikShippingAddress.touched.email && (
                            <span className="error-text">{formikShippingAddress.errors.email}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.address &&
                          formikShippingAddress.touched.address && (
                            <span className="error-text">{formikShippingAddress.errors.address}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.pincode &&
                          formikShippingAddress.touched.pincode && (
                            <span className="error-text">{formikShippingAddress.errors.pincode}</span>
                          )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.city &&
                          formikShippingAddress.touched.city && (
                            <span className="error-text">{formikShippingAddress.errors.city}</span>
                          )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikShippingAddress.errors.state &&
                          formikShippingAddress.touched.state && (
                            <span className="error-text">{formikShippingAddress.errors.state}</span>
                          )}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        <input
                          ...
                          placeholder="Enter your name"
                        />
                        {formikAddShippingAddress.errors.name && formikAddShippingAddress.touched.name && (
                          <span className="error-text">{formikAddShippingAddress.errors.name}</span>
                        )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.mobile &&
                          formikAddShippingAddress.touched.mobile && (
                            <span className="error-text">{formikAddShippingAddress.errors.mobile}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.email &&
                          formikAddShippingAddress.touched.email && (
                            <span className="error-text">{formikAddShippingAddress.errors.email}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.address &&
                          formikAddShippingAddress.touched.address && (
                            <span className="error-text">{formikAddShippingAddress.errors.address}</span>
                          )}
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.pincode &&
                          formikAddShippingAddress.touched.pincode && (
                            <span className="error-text">{formikAddShippingAddress.errors.pincode}</span>
                          )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.city &&
                          formikAddShippingAddress.touched.city && (
                            <span className="error-text">{formikAddShippingAddress.errors.city}</span>
                          )}
                      </div>
                    </div>
                    <div className="col-lg-6">
                      <div className="form-group">
                        ...
                        {formikAddShippingAddress.errors.state &&
                          formikAddShippingAddress.touched.state && (
                            <span className="error-text">{formikAddShippingAddress.errors.state}</span>
                          )}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="row mb-4">
                    <div className="col-lg-12">
                      <ToggleButtonGroup
                        ...
                        onChange={(value) =>
                          formikAddShippingAddress.setFieldValue("address_type", value)
                        }
                        className="d-flex gap-2"
                      >
                        {["Home", "Office", "Others"].map((item) => {
                          return (
                            <CustomToggleButton
                              key={item}
                              onClick={() => {
                                formikAddShippingAddress.setFieldValue("address_type", item);
                              }}
                              isSelected={formikAddShippingAddress.values.address_type === item}
                              value={item}
                            >
                              {item}
                            </CustomToggleButton>
          ...
          <Modal.Body>
            <div className="form-group">
              <label className="rate-product" htmlFor="title">
                ...
                Are you sure want to delete the <b>{userAddressData && userAddressData.name}</b> address
              </label>
            </div>
            <div>
              <button

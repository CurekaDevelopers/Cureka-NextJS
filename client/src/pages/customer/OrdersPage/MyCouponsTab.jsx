  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Access and manage your coupons on Cureka. View available discounts, track expiration dates, and apply coupon codes at checkout for savings on your next purchase." />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Cureka" />
        <meta property="og:description" content="Access and manage your coupons on Cureka. View available discounts, track expiration dates, and apply coupon codes at checkout for savings on your next purchase" />
                ...
                <div key={item.id}>
                  < div className="col-lg-12 d-lg-flex d-flex-column justify-content-between p-0" >
                    ...
                    <p className="valid-date">
                      Valid till   {new Date(item.end_date).toLocaleString('en-US', {
                        year: 'numeric',
                        month: 'short',
                        day: 'numeric',
                        hour: 'numeric',

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Explore Cureka's blog for insightful advice and tips on skincare, haircare routines and more. Keep following our blog for more contents." />
        <link rel="canonical" href={window.location.href} />
        <meta property="og:url" content={window.location.href} />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Cureka" />
        <meta property="og:description" content="Explore Cureka's blog for insightful advice and tips on skincare, haircare routines and more. Keep following our blog for more contents." />
      ...
      <div className="container-fluid px-0">
        ...
        <div className="container">
                          ...
                          <div>
                            ...
                            >
                              <div className="item blog-overlay">
                                ...
                                <div className="d-flex image-space user-space mb-0">
                                  <img
                                    src={calendarday}
                                    width="20px"
                                    height="20px"
                                  ...
                                  <p className="blog-usertwo align-self-center mb-0">
                                    {dayjs(blog.blog_date).format("DD MMMM, YYYY")}
                                  </p>

                                  <div className="date-bordertwo"></div>
                                ...
                                <div className="d-flex-column">
                                  <h2 className="blog-choose">{blog.title}</h2>

                                  <p className="blog-choose-para d-none d-lg-block">
                                    {blog.description}
                                  </p>
                                </div>
                              </div> */}
          ...
          {/* {!searchTerm && !!blogsInCurrentWeek?.length && (
            <>
              <h2 className="this-week">This Week</h2>
              <div className="row">
                {blogsInCurrentWeek?.map((blog) => {
                  return (
                    <Link to={`/blogs/${blog.url}`} key={blog.id} className="col-lg-6 mb-4 blog-overlay">
                      <img
                        src={blog.thumbnail_image}
                        style={{ borderRadius: "21px", height: 311 }}
                        className="img-fluid object-fit-fill"
                        alt="weeklyblog1"
                      />

                      <div className="weekly-caption" id="blog-home">
                        <div className="d-flex week-userspace ">
                          <img
                            src={calendarday}
                            width="20px"
                            height="20px"
                          ...
                          <p className="weekblog-usertwo align-self-center mb-0">
                            {dayjs(blog.blog_date).format("DD MMMM, YYYY")}
                          </p>
                          ...
                          <p className="weekblog-usertwo align-self-center mb-0">By Cureka Admin</p>
                        </div>

                        <div className="d-flex-column">
                          <h2 className="weekblog-choose">{blog.title}</h2>

                          <p className="weekblog-para text-left">{blog.description}</p>
                        </div>
                      </div>
                    </Link>
                  );
          ...
          {!searchTerm && (
            <>
              <h1 className="doctors-heading mb-1 font-weight-bold text-center">Cureka: Blogs</h1>
              ...
              <div className="row recent-blog" id="blog-card">
                {!!trendingBlogs?.length &&
                  trendingBlogs?.map((blog, index) => {
                    return (
                      <div key={blog.id} className={`col-lg-4 col-md-6 ${index !== 0 ? "blog-space" : ""}`}>
              ...
              <div className="row">
                {latestBlog?.[0] && (
                  <Link to={`/blogs/${latestBlog?.[0]?.url}`}
                    target="_blank"
                    className="col-lg-6">
                    <img
                    ...
                    <div className="d-flex image-space user-space">
                      ...
                      <p className="blog-user align-self-center mb-0">
                        {" "}
                        {dayjs(latestBlog?.[0]?.blog_date).format("DD MMMM, YYYY")}
                      </p>
                      ...
                      return (
                        ...
                        >
                          <div className="releate-img">
                            <img className="img-fluid" src={blog.thumbnail_image} alt="blog4" />
                          </div>
              ...
              <div className="d-lg-flex flex-wrap d-flex-column mb-4">
                <div className="facewash-space">
                  <button
                    ...
                    className={`text-decoration-none ${!selectedCategory ? "reorder-btn" : "face-btn"
                      }`}
                  >
                    All
                  </button>
                ...
                {!!Object.keys(blogCategoryWise).length &&
                  Object.keys(blogCategoryWise).map((label) => {
                    return (
                      ...
                      >
                        <button
                          className={`text-decoration-none ${selectedCategory === label ? "reorder-btn" : "face-btn"
                            }`}
                        >
                          {label}
                        </button>
          ...
          <div className="row mt-5 mb-lg-5 mb-2">
            {(
              (selectedCategory
                ? !!blogCategoryWise[selectedCategory]?.length && blogCategoryWise[selectedCategory]
                : blogs?.length && blogs) || []
            )?.map((blog) => {
              return (
                <Link to={`/blogs/${blog.url}`} key={blog.id}
                  target="_blank"
                  className="col-lg-6">
          ...
          {!searchTerm && (
            <>
              ...
              <div className="d-lg-flex flex-wrap d-flex-column mb-4">
                <div className="facewash-space">
                  <button
                    ...
                    className={`text-decoration-none ${!selectedConcern ? "reorder-btn" : "face-btn"
                      }`}
                  >
                    All
                  </button>
                ...
                {!!Object.keys(blogConcernWise).length &&
                  Object.keys(blogConcernWise).map((label) => {
                    return (
                      ...
                      >
                        <button
                          className={`text-decoration-none ${selectedConcern === label ? "reorder-btn" : "face-btn"
                            }`}
                        >
                          {label}
                        </button>
              ...
              <div className="row mt-5 mb-lg-5 mb-2">
                {(
                  (selectedConcern
                    ? !!blogConcernWise[selectedConcern]?.length && blogConcernWise[selectedConcern]
                    : blogs?.length && blogs) || []
                )?.map((blog) => {
                  return (
                    <Link to={`/blogs/${blog.url}`} key={blog.id}
